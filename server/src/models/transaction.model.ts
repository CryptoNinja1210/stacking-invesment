...
const { param } = require('../routes/api/depositInfo.route.ts');
...
class TransactionModel {
    ...
    create = async (params) => {
        try {
            ...
            (userid,message,transaction) VALUES (?,?,?)`;
            const result = await query(sql, [params.userid, params.message, params.transaction]);
