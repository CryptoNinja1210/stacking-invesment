  ...
  return (
    <Row className='mt-16 p-4'>
        <Col span={24} className='mt-16 text-center text-white'>
            ...
            <Row className=''>
                <Col xs={{span:20, offset:2}} md={{span:6, offset:0}}  className='mt-8 bg-neutral-800 p-4'>
                ...
                <Col xs={{span:20, offset:2}} md={{span:6, offset:0}} className='mt-8 bg-neutral-900 p-4'>
